...
def _get_api_key():
    ...
    Expects a configuration file name "secrets.ini" with structure:
...
def read_user_cli_args():
    """Handles the CLI user interactions.ini
...
def build_weather_query(city_input, imperial=False):
    ...
    Args:
        ...
        imperial (bool): Wether or not to use imperial units for temperature 
...
def get_weather_data(query_url):
    ...
    Returns:
        dict: Weather information for a specific city endpoint
    ...
    try:
        ...
        sys.exit("Couldn't decode the server response")
